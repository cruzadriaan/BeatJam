...
export const Order = () => {
    return (
        <>
            <div className='flex flex-col gap-5 pt-[20px] m-10 border border-gray-300  rounded-xl h-[550px] w-[800px] drop-shadow-sm items-center mx-auto'>
                ...
                <form className='flex flex-col gap-5 w-[500px]'>
                    <div className='flex items-left gap-5'>
                        <label className='text-sm text-left font-semibold text-gray-700'>
                            First Name:
                            <input type="text" className='border border-gray-400 p-1  w-[250px] rounded-md' required />
                        </label>
                    ...
                    <div className='flex flex-row gap-10'>
                        <label className='text-sm text-left font-semibold  text-gray-700 '>
                            Email Address:
                            <input type="email" placeholder="(optional)" className='border border-gray-400  p-1 ml-1 w-[500px] rounded-md' />
                        </label>
                    </div>
                    ...
                    <div className='flex flex-col gap-2  '>
                        <div className='flex flex-col '>
                            ...
                            <textarea type="text" className='border border-gray-400  p-1  w-[500px] rounded-md' required />
                        </div>
                ...
                <div className='flex flex-col justify-center items-center h-dv mt-20'>
